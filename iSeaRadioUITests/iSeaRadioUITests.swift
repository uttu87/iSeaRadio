...
class iSeaRadioUITests: XCTestCase {
    
    let app = XCUIApplication()
    let stations = XCUIApplication().cells
    let hamburgerMenu = XCUIApplication().navigationBars["iSea Radio"].buttons["icon hamburger"]
    ...
    func testMainStationsView() {
        ...
        app.navigationBars["iSea Radio"].buttons["btn nowPlaying"].tap()
        waitForStationToLoad()
